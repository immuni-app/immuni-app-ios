...
public struct Configuration: Codable {
    ...
    public func faqURL(for language: UserLanguage) -> URL? {
        return faqURL[language.rawValue] ?? faqURL[UserLanguage.english.rawValue]
    }
    ...
    public func termsOfUseURL(for language: UserLanguage) -> URL? {
        return termsOfUseURL[language.rawValue] ?? termsOfUseURL[UserLanguage.english.rawValue]
    }
    ...
    public func privacyNoticeURL(for language: UserLanguage) -> URL? {
        return privacyNoticeURL[language.rawValue] ?? privacyNoticeURL[UserLanguage.english.rawValue]
    }
    ...
    public init(
        ...
        dummyAnalyticsMeanStochasticDelay = dummyAnalyticsWaitingTime
