// DownloadKeyChunkRequestEU.swift
...
public struct DownloadKeyChunkIndexRequestEU: HTTPRequest {
  ...
  public var path: String { "/v1/keys/eu/\(self.country)/\(self.chunkNumber)" }
  let chunkNumber: Int
  let country: String
}
