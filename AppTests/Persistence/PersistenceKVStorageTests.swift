// PersistenceKVStorageTests.swift
...
final class PersistenceKVStorageTests: XCTestCase {
  ...
  override func setUp() {
    ...
    self.storage = KVStorage(userDefaults: self.userDefaults, encryptionKey: nil)
  }

  override func tearDown() {
    super.tearDown()

    UserDefaults.standard.removePersistentDomain(forName: "com.test")
