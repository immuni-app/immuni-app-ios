...
struct CertificatesHeaderVM: ViewModel {}

// MARK: - View

class CertificatesHeaderView: UIView, ModellableView {
    
    static let horizontalMargin: CGFloat = 30.0
    static let textToDiscoverMore: CGFloat = 10.0

    typealias VM = CertificatesHeaderVM
...
private extension CertificatesHeaderView {
    enum Style {
        ...
        static func message(_ label: UILabel) {
            let content = L10n.Certificate.CertificatesView.Header.message
