...
struct HomeInfoHeaderCellVM: ViewModel {}

class HomeInfoHeaderCell: UICollectionViewCell, ModellableView, ReusableView {
  typealias VM = HomeInfoHeaderCellVM
...
private extension HomeInfoHeaderCell {
  enum Style {
    ...
    static func title(_ label: UILabel) {
      let content = L10n.HomeView.InfoHeader.title
