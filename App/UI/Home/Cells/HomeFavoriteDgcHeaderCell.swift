// HomeFavoriteDgcHeaderCell.swift
...
struct HomeFavoriteDgcHeaderCellVM: ViewModel {}

class HomeFavoriteDgcHeaderCell: UICollectionViewCell, ModellableView, ReusableView {
  typealias VM = HomeFavoriteDgcHeaderCellVM
...
private extension HomeFavoriteDgcHeaderCell {
  enum Style {
    ...
    static func title(_ label: UILabel) {
      let content = L10n.HomeView.InfoHeader.favoriteCertificate
