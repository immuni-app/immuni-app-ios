// OnboardingPermissionOverlayUITests.swift
...
class OnboardingPermissionOverlayUITests: AppViewTestCase, ViewTestCase {
  typealias V = OnboardingPermissionOverlayView
